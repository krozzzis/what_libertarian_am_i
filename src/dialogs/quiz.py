...
import quiz
from quiz import QuizData, get_ideology_data
...
async def get_quiz_data(dialog_manager: DialogManager, **kwargs):
    quiz_data: quiz.QuizData | None = quiz.QUIZ_DATA
...
async def choose_answer(callback: CallbackQuery, widget: Any, manager: DialogManager, item_id: str):
    ...
    quiz_data: QuizData | None = quiz.QUIZ_DATA
    ...
    logger.info("Selected answer for question {}/{}: '{}' (Choice: {})", current + 1, total, question.text, answer_text)
